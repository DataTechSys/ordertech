...
struct StatusChipView: View {
    ...
    let provider: String? // Live | Mock (P2P deprecated)
    ...
    private var bgColor: Color {
        ...
        case "connected": return Color.orange
    ...
    private var dotColor: Color {
        // Updated requirement: when connected, show orange; otherwise keep orange for not-connected states as well
        if status.lowercased() == "connected" { return Color.orange }
        return Color.orange
    }
}
