        ...
        if #available(iOS 16.0, macOS 12.0, *) {
            do {
                ...
                let cats = activeCategories.map { fc in
                    Category(id: fc.id, name: fc.name, name_localized: fc.name_localized, reference: fc.reference)
                }
                ...
                for (index, fp) in activeProducts.enumerated() {
                    ...
                    // Build description_localized dictionary properly
                    var descLocalized: [String: String]? = nil
                    if let arDesc = fp.description_localized, !arDesc.isEmpty {
                        descLocalized = ["ar": arDesc]
                    }
                ...
                // Map modifiers for this product using the ModifierReferenceTable
                    ...
                    prods.append(Product(
                        ...
                        description_localized: descLocalized,
