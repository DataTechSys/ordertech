...
public struct Product: Codable, Identifiable, Equatable {
    ...
    public let description_localized: [String: String]?
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, name_localized, price, category, category_id, category_name, description, description_localized, modifiers
        case imageURL = "image_url"
    }
    
    public init(id: String, name: String, price: Double, imageURL: String? = nil, category: String? = nil, category_id: String? = nil, category_name: String? = nil, description: String? = nil, description_localized: [String: String]? = nil, name_localized: [String: String]? = nil, modifiers: [ModifierGroup]? = nil) {
        self.id = id
        self.name = name
        self.name_localized = name_localized
        self.price = price
...
public struct Category: Codable, Identifiable, Equatable {
    ...
    public init(id: String, name: String, name_localized: String? = nil, reference: String? = nil) {
        self.id = id
        self.name = name
        self.name_localized = name_localized
