...
async function testKoobsDisplays() {
  console.log('Testing /presence/displays endpoint for Koobs cafe...');
  console.log('====================================================');
  ...
  try {
    ...
    if (response.data?.items) {
      ...
      if (items.length === 0) {
        console.log('\n⚠️  No display devices found for this tenant.');
        console.log('   This could mean:');
        console.log('   1. No display devices are registered for Koobs cafe');
        console.log('   2. The server changes haven\'t been deployed to production yet');
        console.log('   3. The tenant UUID is incorrect');
      }
    }
