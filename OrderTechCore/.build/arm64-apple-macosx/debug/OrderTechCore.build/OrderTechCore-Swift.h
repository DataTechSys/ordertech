...
#ifndef ORDERTECHCORE_SWIFT_H
#define ORDERTECHCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OrderTechCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSData;
SWIFT_CLASS("_TtC13OrderTechCore16WebSocketManager") SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(ios,introduced=16.0)
