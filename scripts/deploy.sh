...
gcloud run deploy "$SERVICE" \
  ...
  --set-secrets "DATABASE_URL=DATABASE_URL:latest,LIVEKIT_WS_URL=livekit-ws-url:latest,LIVEKIT_API_KEY=livekit-api-key:latest,LIVEKIT_API_SECRET=livekit-api-secret:latest" \
